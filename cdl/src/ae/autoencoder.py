...
class AutoEncoder(object):
  ...
  def __init__(self, shape, sess): #checked
  ...
  def _setup_variables(self): #checked
    with tf.name_scope("autoencoder_variables"):
      ...
      for i in xrange(self.__num_hidden_layers):
        ...
        a = tf.mul(4.0, tf.sqrt(6.0 / (w_shape[0] + w_shape[1]))) #difer from matlab. see default_sdae.m
...
loss_summaries = {} # loss summary as global variable for training and set in the unsupervised training
